...
public class AppTest {
    ...
    void testShowPerson() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentAsString().contains("John")).isTrue();
    }
    ...
    void testUpdatePerson() throws Exception {
        MockHttpServletResponse updateResponse = mockMvc
                .perform(patch("/people/{id}", 1)
                        ...
                        .content("{\"firstName\": \"Ivan\", \"lastName\": \"Lo\"}")
                )
                .andReturn()
                .getResponse();
        ...
        MockHttpServletResponse response = mockMvc
                .perform(get("/people/{1}", 1))
                        .andReturn()
                        .getResponse();

        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentAsString().contains("Ivan")).isTrue();
    }
